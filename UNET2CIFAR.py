...
class UNetEnhancedCIFAR(nn.Module):
    def __init__(self, in_channels=3, base_channels=128, dropout=0.1, out_channels=3):
        super().__init__()
        # Encodeur
        self.enc1 = ResidualConvBlock(in_channels + 1, base_channels)  # +1 pour le t_map
    ...
    def forward(self, x, t):
        # t_map : ajout du temps comme canal supplémentaire
